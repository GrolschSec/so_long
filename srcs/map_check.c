...
/*   Updated: 2022/10/12 13:55:17 by rlouvrie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{	
	/*check if the file is finishing by .ber
	check if the fd is greater than 0 if not error
	then parse the file and check that is it conform
	if not conform close the fd
	*/
	return (0);
}
